/* global p5, mouseIsPressed, fill, stroke, strokeWeight, rect, noStroke, textAlign, CENTER, textSize, textFont, text, mouseX, mouseY */

console.log("### p5.clickable ###");
...
function Clickable() {
  ...
  this.textFont = "Bangers"; //Font for the text shown
  ...
  this.draw = function() {
    ...
    //textFont(loadFont('assets/Bold.ttf'));
